...
bashcmd=$(append_cmd "$bashcmd" "export VTROOT=/vt/src/mdibaiee/vitess/oracle")
...
bashcmd=$(append_cmd "$bashcmd" "rm -rf /vt/dist; ln -s /vt/src/mdibaiee/vitess/oracle/dist /vt/dist")
bashcmd=$(append_cmd "$bashcmd" "rm -rf /vt/bin; ln -s /vt/src/mdibaiee/vitess/oracle/bin /vt/bin")
bashcmd=$(append_cmd "$bashcmd" "rm -rf /vt/lib; ln -s /vt/src/mdibaiee/vitess/oracle/lib /vt/lib")
bashcmd=$(append_cmd "$bashcmd" "rm -rf /vt/vthook; ln -s /vt/src/mdibaiee/vitess/oracle/vthook /vt/vthook")
