...
import (
	...
	"github.com/estuary/vitess/go/vt/vtctl/localvtctldclient"
	"github.com/estuary/vitess/go/vt/vtctl/vtctldclient"
	...
	vreplcommon "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/common"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/lookupvindex"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/materialize"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/migrate"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/mount"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/movetables"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/reshard"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/vdiff"
	_ "github.com/estuary/vitess/go/cmd/vtctldclient/command/vreplication/workflow"

	// These imports register the topo factories to use when --server=internal.
	_ "github.com/estuary/vitess/go/vt/topo/consultopo"
	_ "github.com/estuary/vitess/go/vt/topo/etcd2topo"
