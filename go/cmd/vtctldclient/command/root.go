...
import (
	...
	vreplcommon "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/common"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/lookupvindex"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/materialize"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/migrate"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/mount"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/movetables"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/reshard"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/vdiff"
	_ "mdibaiee/vitess/go/cmd/vtctldclient/command/vreplication/workflow"
