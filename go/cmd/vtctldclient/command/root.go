...
import (
	...
	vreplcommon "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/common"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/lookupvindex"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/materialize"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/migrate"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/mount"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/movetables"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/reshard"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/vdiff"
	_ "mdibaiee/vitess/oracle/go/cmd/vtctldclient/command/vreplication/workflow"
