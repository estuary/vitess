...
func (cached *Environment) CachedSize(alloc bool) int64 {
	...
	// field byName map[string]mdibaiee/vitess/go/mysql/collations.ID
	...
	// field byCharset map[string]*mdibaiee/vitess/go/mysql/collations.colldefaults
	...
	// field byCharsetName map[mdibaiee/vitess/go/mysql/collations.ID]string
	...
	// field unsupported map[string]mdibaiee/vitess/go/mysql/collations.ID
	...
	// field byID map[mdibaiee/vitess/go/mysql/collations.ID]string
	if cached.byID != nil {
		size += int64(48)
