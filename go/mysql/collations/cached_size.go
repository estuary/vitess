...
func (cached *Environment) CachedSize(alloc bool) int64 {
	...
	// field byName map[string]github.com/estuary/vitess/go/mysql/collations.ID
	...
	// field byCharset map[string]*github.com/estuary/vitess/go/mysql/collations.colldefaults
	...
	// field byCharsetName map[github.com/estuary/vitess/go/mysql/collations.ID]string
	...
	// field unsupported map[string]github.com/estuary/vitess/go/mysql/collations.ID
	...
	// field byID map[github.com/estuary/vitess/go/mysql/collations.ID]string
	if cached.byID != nil {
		size += int64(48)
