...
const PkgCollationsData codegen.Package = "mdibaiee/vitess/oracle/go/mysql/collations/colldata"
const PkgCharset codegen.Package = "mdibaiee/vitess/oracle/go/mysql/collations/charset"
