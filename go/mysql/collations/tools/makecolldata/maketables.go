...
func maketables(embed bool, output string, metadata AllMetadata) {
	...
	var g = codegen.NewGenerator("github.com/vitess/vitess/go/mysql/collations/colldata")
	var fastg = codegen.NewGenerator("github.com/vitess/vitess/go/mysql/collations/internal/uca")
