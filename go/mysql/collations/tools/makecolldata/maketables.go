...
func maketables(embed bool, output string, metadata AllMetadata) {
	...
	var g = codegen.NewGenerator("github.com/mdibaiee/vitess/go/mysql/collations/colldata")
	var fastg = codegen.NewGenerator("github.com/mdibaiee/vitess/go/mysql/collations/internal/uca")
