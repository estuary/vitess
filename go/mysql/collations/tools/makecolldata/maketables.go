...
func maketables(embed bool, output string, metadata AllMetadata) {
	...
	var g = codegen.NewGenerator("github.com/estuary/vitess/go/mysql/collations/colldata")
	var fastg = codegen.NewGenerator("github.com/estuary/vitess/go/mysql/collations/internal/uca")
