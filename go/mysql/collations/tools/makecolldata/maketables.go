...
func maketables(embed bool, output string, metadata AllMetadata) {
	...
	var g = codegen.NewGenerator("mdibaiee/vitess/go/mysql/collations/colldata")
	var fastg = codegen.NewGenerator("mdibaiee/vitess/go/mysql/collations/internal/uca")
