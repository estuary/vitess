...
func maketables(embed bool, output string, metadata AllMetadata) {
	...
	var g = codegen.NewGenerator("mdibaiee/vitess/oracle/go/mysql/collations/colldata")
	var fastg = codegen.NewGenerator("mdibaiee/vitess/oracle/go/mysql/collations/internal/uca")
