...
func (cached *Object) CachedSize(alloc bool) int64 {
	...
	// field kvs []github.com/vitess/vitess/go/mysql/json.kv
	{
...
func (cached *Value) CachedSize(alloc bool) int64 {
	...
	// field o github.com/vitess/vitess/go/mysql/json.Object
	size += cached.o.CachedSize(false)
	// field a []*github.com/vitess/vitess/go/mysql/json.Value
	{
...
func (cached *kv) CachedSize(alloc bool) int64 {
	...
	// field v *github.com/vitess/vitess/go/mysql/json.Value
