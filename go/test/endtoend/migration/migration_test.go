...
externalConnections:
	...
	product:
	  socket: /home/sougou/dev/src/github.com/vitess/vitess/vtdataroot/vtroot_15201/vt_0000000622/mysql.sock
	  dbName: vt_product
	  app:
	    user: vt_app
	  dba:
	...
	customer:
	  flavor: FilePos
	  socket: /home/sougou/dev/src/github.com/vitess/vitess/vtdataroot/vtroot_15201/vt_0000000620/mysql.sock
	  dbName: vt_customer
	  app:
	    user: vt_app
	  dba:
