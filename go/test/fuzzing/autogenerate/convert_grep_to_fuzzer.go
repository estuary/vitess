...
var importPathShort = map[string]string{
	"github.com/estuary/vitess/go/vt/proto/query":             "query",
	"github.com/estuary/vitess/go/vt/proto/tabletmanagerdata": "tabletmanagerdata",
	"github.com/estuary/vitess/go/vt/proto/binlogdata":        "binlogdata",
	"github.com/estuary/vitess/go/vt/proto/vtgate":            "vtgate",
	"github.com/estuary/vitess/go/vt/proto/automation":        "automation",
	"github.com/estuary/vitess/go/vt/proto/tableacl":          "tableacl",
	"github.com/estuary/vitess/go/vt/proto/logutil":           "logutil",
	"github.com/estuary/vitess/go/vt/proto/vttest":            "vttest",
	"github.com/estuary/vitess/go/vt/proto/vttime":            "vttime",
	"github.com/estuary/vitess/go/vt/proto/workflow":          "workflow",
	"github.com/estuary/vitess/go/vt/proto/replicationdata":   "replicationdata",
	"github.com/estuary/vitess/go/vt/proto/vtctldata":         "vtctldata",
	"github.com/estuary/vitess/go/vt/proto/vtrpc":             "vtrpc",
	"github.com/estuary/vitess/go/vt/proto/vschema":           "vschema",
	"github.com/estuary/vitess/go/vt/proto/mysqlctl":          "mysqlctl",
	"github.com/estuary/vitess/go/vt/proto/vtadmin":           "vtadmin",
	"github.com/estuary/vitess/go/vt/proto/throttlerdata":     "throttlerdata",
	"github.com/estuary/vitess/go/vt/proto/topodata":          "topodata",
}
...
var pathToImportPath = map[string]string{
	"./proto/query/query_vtproto.pb.go":                         "github.com/estuary/vitess/go/vt/proto/query",
	"./proto/tabletmanagerdata/tabletmanagerdata_vtproto.pb.go": "github.com/estuary/vitess/go/vt/proto/tabletmanagerdata",
	"./proto/binlogdata/binlogdata_vtproto.pb.go":               "github.com/estuary/vitess/go/vt/proto/binlogdata",
	"./proto/vtgate/vtgate_vtproto.pb.go":                       "github.com/estuary/vitess/go/vt/proto/vtgate",
	"./proto/automation/automation_vtproto.pb.go":               "github.com/estuary/vitess/go/vt/proto/automation",
	"./proto/tableacl/tableacl_vtproto.pb.go":                   "github.com/estuary/vitess/go/vt/proto/tableacl",
	"./proto/logutil/logutil_vtproto.pb.go":                     "github.com/estuary/vitess/go/vt/proto/logutil",
	"./proto/vttest/vttest_vtproto.pb.go":                       "github.com/estuary/vitess/go/vt/proto/vttest",
	"./proto/vttime/vttime_vtproto.pb.go":                       "github.com/estuary/vitess/go/vt/proto/vttime",
	"./proto/workflow/workflow_vtproto.pb.go":                   "github.com/estuary/vitess/go/vt/proto/workflow",
	"./proto/replicationdata/replicationdata_vtproto.pb.go":     "github.com/estuary/vitess/go/vt/proto/replicationdata",
	"./proto/vtctldata/vtctldata_vtproto.pb.go":                 "github.com/estuary/vitess/go/vt/proto/vtctldata",
	"./proto/vtrpc/vtrpc_vtproto.pb.go":                         "github.com/estuary/vitess/go/vt/proto/vtrpc",
	"./proto/vschema/vschema_vtproto.pb.go":                     "github.com/estuary/vitess/go/vt/proto/vschema",
	"./proto/mysqlctl/mysqlctl_vtproto.pb.go":                   "github.com/estuary/vitess/go/vt/proto/mysqlctl",
	"./proto/vtadmin/vtadmin_vtproto.pb.go":                     "github.com/estuary/vitess/go/vt/proto/vtadmin",
	"./proto/throttlerdata/throttlerdata_vtproto.pb.go":         "github.com/estuary/vitess/go/vt/proto/throttlerdata",
	"./proto/topodata/topodata_vtproto.pb.go":                   "github.com/estuary/vitess/go/vt/proto/topodata",
}
