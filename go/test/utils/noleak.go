...
func ensureNoGoroutines() error {
	var ignored = []goleak.Option{
		...
		goleak.IgnoreTopFunction("github.com/estuary/vitess/go/vt/dbconfigs.init.0.func1"),
		goleak.IgnoreTopFunction("github.com/estuary/vitess/go/vt/vtgate.resetAggregators"),
		goleak.IgnoreTopFunction("github.com/estuary/vitess/go/vt/vtgate.processQueryInfo"),
		goleak.IgnoreTopFunction("github.com/patrickmn/go-cache.(*janitor).Run"),
		goleak.IgnoreTopFunction("github.com/estuary/vitess/go/vt/logutil.(*ThrottledLogger).log.func1"),
		goleak.IgnoreTopFunction("github.com/estuary/vitess/go/vt/vttablet/tabletserver/throttle.initThrottleTicker.func1.1"),
		goleak.IgnoreTopFunction("github.com/estuary/vitess/go/vt/vttablet/tabletserver/throttle.NewBackgroundClient.initThrottleTicker.func1.1"),
