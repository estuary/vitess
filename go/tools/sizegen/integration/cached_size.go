...
func (cached *C) CachedSize(alloc bool) int64 {
	...
	// field field1 github.com/estuary/vitess/go/tools/sizegen/integration.B
...
func (cached *D) CachedSize(alloc bool) int64 {
	...
	// field field1 *github.com/estuary/vitess/go/tools/sizegen/integration.Bimpl
...
func (cached *Map2) CachedSize(alloc bool) int64 {
	...
	// field field1 map[uint64]github.com/estuary/vitess/go/tools/sizegen/integration.A
	if cached.field1 != nil {
		size += int64(48)
		hmap := reflect.ValueOf(cached.field1)
		numBuckets := int(math.Pow(2, float64((*(*uint8)(unsafe.Pointer(hmap.Pointer() + uintptr(9)))))))
...
func (cached *Map3) CachedSize(alloc bool) int64 {
	...
	// field field1 map[uint64]github.com/estuary/vitess/go/tools/sizegen/integration.B
	if cached.field1 != nil {
		size += int64(48)
		hmap := reflect.ValueOf(cached.field1)
		numBuckets := int(math.Pow(2, float64((*(*uint8)(unsafe.Pointer(hmap.Pointer() + uintptr(9)))))))
...
func (cached *Slice1) CachedSize(alloc bool) int64 {
	...
	// field field1 []github.com/estuary/vitess/go/tools/sizegen/integration.A
	{
