...
func (cached *AddColumns) CachedSize(alloc bool) int64 {
	...
	// field Columns []*github.com/vitess/vitess/go/vt/sqlparser.ColumnDefinition
	{
	...
	// field After *github.com/vitess/vitess/go/vt/sqlparser.ColName
...
func (cached *AddConstraintDefinition) CachedSize(alloc bool) int64 {
	...
	// field ConstraintDefinition *github.com/vitess/vitess/go/vt/sqlparser.ConstraintDefinition
...
func (cached *AddIndexDefinition) CachedSize(alloc bool) int64 {
	...
	// field IndexDefinition *github.com/vitess/vitess/go/vt/sqlparser.IndexDefinition
...
func (cached *AliasedExpr) CachedSize(alloc bool) int64 {
	...
	// field As github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
...
func (cached *AliasedTableExpr) CachedSize(alloc bool) int64 {
	...
	// field Expr github.com/vitess/vitess/go/vt/sqlparser.SimpleTableExpr
	if cc, ok := cached.Expr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Partitions github.com/vitess/vitess/go/vt/sqlparser.Partitions
	{
	...
	// field As github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.As.CachedSize(false)
	// field Hints github.com/vitess/vitess/go/vt/sqlparser.IndexHints
	{
	...
	// field Columns github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *AlterCheck) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
...
func (cached *AlterColumn) CachedSize(alloc bool) int64 {
	...
	// field Column *github.com/vitess/vitess/go/vt/sqlparser.ColName
	size += cached.Column.CachedSize(true)
	// field DefaultVal github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *AlterDatabase) CachedSize(alloc bool) int64 {
	...
	// field DBName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.DBName.CachedSize(false)
	// field AlterOptions []github.com/vitess/vitess/go/vt/sqlparser.DatabaseOption
	{
...
func (cached *AlterMigration) CachedSize(alloc bool) int64 {
	...
	// field Ratio *github.com/vitess/vitess/go/vt/sqlparser.Literal
...
func (cached *AlterTable) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.Table.CachedSize(false)
	// field AlterOptions []github.com/vitess/vitess/go/vt/sqlparser.AlterOption
	{
	...
	// field PartitionSpec *github.com/vitess/vitess/go/vt/sqlparser.PartitionSpec
	size += cached.PartitionSpec.CachedSize(true)
	// field PartitionOption *github.com/vitess/vitess/go/vt/sqlparser.PartitionOption
	size += cached.PartitionOption.CachedSize(true)
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
...
func (cached *AlterView) CachedSize(alloc bool) int64 {
	...
	// field ViewName github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.ViewName.CachedSize(false)
	// field Algorithm string
	size += hack.RuntimeAllocSize(int64(len(cached.Algorithm)))
	// field Definer *github.com/vitess/vitess/go/vt/sqlparser.Definer
	...
	// field Select github.com/vitess/vitess/go/vt/sqlparser.SelectStatement
...
func (cached *AlterVschema) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.Table.CachedSize(false)
	// field VindexSpec *github.com/vitess/vitess/go/vt/sqlparser.VindexSpec
	size += cached.VindexSpec.CachedSize(true)
	// field VindexCols []github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	{
	...
	// field AutoIncSpec *github.com/vitess/vitess/go/vt/sqlparser.AutoIncSpec
...
func (cached *AndExpr) CachedSize(alloc bool) int64 {
	...
	// field Left github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Left.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Right github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *AnyValue) CachedSize(alloc bool) int64 {
	...
	// field Arg github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *ArgumentLessWindowExpr) CachedSize(alloc bool) int64 {
	...
	// field OverClause *github.com/vitess/vitess/go/vt/sqlparser.OverClause
...
func (cached *AutoIncSpec) CachedSize(alloc bool) int64 {
	...
	// field Column github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Column.CachedSize(false)
	// field Sequence github.com/vitess/vitess/go/vt/sqlparser.TableName
...
func (cached *Begin) CachedSize(alloc bool) int64 {
	...
	// field TxAccessModes []github.com/vitess/vitess/go/vt/sqlparser.TxAccessMode
	{
...
func (cached *BetweenExpr) CachedSize(alloc bool) int64 {
	...
	// field From github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.From.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field To github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *CallProc) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.Name.CachedSize(false)
	// field Params github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *CaseExpr) CachedSize(alloc bool) int64 {
	...
	// field Whens []*github.com/vitess/vitess/go/vt/sqlparser.When
	{
	...
	// field Else github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *CastExpr) CachedSize(alloc bool) int64 {
	...
	// field Type *github.com/vitess/vitess/go/vt/sqlparser.ConvertType
...
func (cached *ChangeColumn) CachedSize(alloc bool) int64 {
	...
	// field OldColumn *github.com/vitess/vitess/go/vt/sqlparser.ColName
	size += cached.OldColumn.CachedSize(true)
	// field NewColDefinition *github.com/vitess/vitess/go/vt/sqlparser.ColumnDefinition
...
func (cached *CharExpr) CachedSize(alloc bool) int64 {
	...
	// field Exprs github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *ColName) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Qualifier github.com/vitess/vitess/go/vt/sqlparser.TableName
...
func (cached *ColumnDefinition) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Type *github.com/vitess/vitess/go/vt/sqlparser.ColumnType
	size += cached.Type.CachedSize(true)
	return size
}
func (cached *ColumnType) CachedSize(alloc bool) int64 {
	...
	// field Options *github.com/vitess/vitess/go/vt/sqlparser.ColumnTypeOptions
	size += cached.Options.CachedSize(true)
	// field Length *int
	size += hack.RuntimeAllocSize(int64(8))
	// field Scale *int
	size += hack.RuntimeAllocSize(int64(8))
	// field Charset github.com/vitess/vitess/go/vt/sqlparser.ColumnCharset
...
func (cached *ColumnTypeOptions) CachedSize(alloc bool) int64 {
	...
	// field Null *bool
	size += hack.RuntimeAllocSize(int64(1))
	// field Default github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Default.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field OnUpdate github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.OnUpdate.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field As github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.As.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Comment *github.com/vitess/vitess/go/vt/sqlparser.Literal
	size += cached.Comment.CachedSize(true)
	// field Collate string
	size += hack.RuntimeAllocSize(int64(len(cached.Collate)))
	// field Reference *github.com/vitess/vitess/go/vt/sqlparser.ReferenceDefinition
	size += cached.Reference.CachedSize(true)
	// field Invisible *bool
	size += hack.RuntimeAllocSize(int64(1))
	// field EngineAttribute *github.com/vitess/vitess/go/vt/sqlparser.Literal
	size += cached.EngineAttribute.CachedSize(true)
	// field SecondaryEngineAttribute *github.com/vitess/vitess/go/vt/sqlparser.Literal
	size += cached.SecondaryEngineAttribute.CachedSize(true)
	// field SRID *github.com/vitess/vitess/go/vt/sqlparser.Literal
...
func (cached *CommonTableExpr) CachedSize(alloc bool) int64 {
	...
	// field ID github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	...
	// field Subquery *github.com/vitess/vitess/go/vt/sqlparser.Subquery
...
func (cached *ComparisonExpr) CachedSize(alloc bool) int64 {
	...
	// field Escape github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *ConstraintDefinition) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Details github.com/vitess/vitess/go/vt/sqlparser.ConstraintInfo
...
func (cached *Count) CachedSize(alloc bool) int64 {
	...
	// field Args github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *CreateDatabase) CachedSize(alloc bool) int64 {
	...
	// field DBName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.DBName.CachedSize(false)
	// field CreateOptions []github.com/vitess/vitess/go/vt/sqlparser.DatabaseOption
	{
...
func (cached *CreateTable) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.Table.CachedSize(false)
	// field TableSpec *github.com/vitess/vitess/go/vt/sqlparser.TableSpec
	size += cached.TableSpec.CachedSize(true)
	// field OptLike *github.com/vitess/vitess/go/vt/sqlparser.OptLike
...
func (cached *Delete) CachedSize(alloc bool) int64 {
	...
	// field With *github.com/vitess/vitess/go/vt/sqlparser.With
	size += cached.With.CachedSize(true)
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
	size += cached.Comments.CachedSize(true)
	// field TableExprs []github.com/vitess/vitess/go/vt/sqlparser.TableExpr
	{
	...
	// field Targets github.com/vitess/vitess/go/vt/sqlparser.TableNames
	{
	...
	// field Where *github.com/vitess/vitess/go/vt/sqlparser.Where
	size += cached.Where.CachedSize(true)
	// field OrderBy github.com/vitess/vitess/go/vt/sqlparser.OrderBy
	{
	...
	// field Limit *github.com/vitess/vitess/go/vt/sqlparser.Limit
...
func (cached *DropColumn) CachedSize(alloc bool) int64 {
	...
	// field Name *github.com/vitess/vitess/go/vt/sqlparser.ColName
...
func (cached *DropTable) CachedSize(alloc bool) int64 {
	...
	// field FromTables github.com/vitess/vitess/go/vt/sqlparser.TableNames
	{
...
func (cached *ExecuteStmt) CachedSize(alloc bool) int64 {
	...
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
	size += cached.Comments.CachedSize(true)
	// field Arguments []*github.com/vitess/vitess/go/vt/sqlparser.Variable
	{
...
func (cached *ExplainStmt) CachedSize(alloc bool) int64 {
	...
	// field Statement github.com/vitess/vitess/go/vt/sqlparser.Statement
...
func (cached *ExtractValueExpr) CachedSize(alloc bool) int64 {
	...
	// field Fragment github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Fragment.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field XPathExpr github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *FirstOrLastValueExpr) CachedSize(alloc bool) int64 {
	...
	// field NullTreatmentClause *github.com/vitess/vitess/go/vt/sqlparser.NullTreatmentClause
...
func (cached *Flush) CachedSize(alloc bool) int64 {
	...
	// field TableNames github.com/vitess/vitess/go/vt/sqlparser.TableNames
	{
...
func (cached *ForeignKeyDefinition) CachedSize(alloc bool) int64 {
	...
	// field Source github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
	...
	// field IndexName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.IndexName.CachedSize(false)
	// field ReferenceDefinition *github.com/vitess/vitess/go/vt/sqlparser.ReferenceDefinition
...
func (cached *FrameClause) CachedSize(alloc bool) int64 {
	...
	// field Start *github.com/vitess/vitess/go/vt/sqlparser.FramePoint
	size += cached.Start.CachedSize(true)
	// field End *github.com/vitess/vitess/go/vt/sqlparser.FramePoint
...
func (cached *FuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Qualifier github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.Qualifier.CachedSize(false)
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Exprs github.com/vitess/vitess/go/vt/sqlparser.Exprs
...
func (cached *GTIDFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Set1 github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Set1.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Set2 github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Set2.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Timeout github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Timeout.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Channel github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeoHashFromLatLongExpr) CachedSize(alloc bool) int64 {
	...
	// field Latitude github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Latitude.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Longitude github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Longitude.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field MaxLength github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeoHashFromPointExpr) CachedSize(alloc bool) int64 {
	...
	// field Point github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeoJSONFromGeomExpr) CachedSize(alloc bool) int64 {
	...
	// field Geom github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Geom.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field MaxDecimalDigits github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.MaxDecimalDigits.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Bitmask github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeomCollPropertyFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field GeomColl github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.GeomColl.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field PropertyDefArg github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeomFormatExpr) CachedSize(alloc bool) int64 {
	...
	// field AxisOrderOpt github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeomFromGeoHashExpr) CachedSize(alloc bool) int64 {
	...
	// field GeoHash github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.GeoHash.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field SridOpt github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeomFromGeoJSONExpr) CachedSize(alloc bool) int64 {
	...
	// field GeoJSON github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.GeoJSON.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field HigherDimHandlerOpt github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.HigherDimHandlerOpt.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Srid github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeomFromTextExpr) CachedSize(alloc bool) int64 {
	...
	// field WktText github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GeomFromWKBExpr) CachedSize(alloc bool) int64 {
	...
	// field WkbBlob github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *GroupBy) CachedSize(alloc bool) int64 {
	...
	// field Exprs []github.com/vitess/vitess/go/vt/sqlparser.Expr
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Exprs)) * int64(16))
		for _, elem := range cached.Exprs {
			if cc, ok := elem.(cachedObject); ok {
...
func (cached *IndexColumn) CachedSize(alloc bool) int64 {
	...
	// field Length *int
	size += hack.RuntimeAllocSize(int64(8))
	// field Expression github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *IndexDefinition) CachedSize(alloc bool) int64 {
	...
	// field Info *github.com/vitess/vitess/go/vt/sqlparser.IndexInfo
	size += cached.Info.CachedSize(true)
	// field Columns []*github.com/vitess/vitess/go/vt/sqlparser.IndexColumn
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Columns)) * int64(8))
		for _, elem := range cached.Columns {
			size += elem.CachedSize(true)
	...
	// field Options []*github.com/vitess/vitess/go/vt/sqlparser.IndexOption
	{
...
func (cached *IndexHint) CachedSize(alloc bool) int64 {
	...
	// field Indexes []github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	{
...
func (cached *IndexInfo) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field ConstraintName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
...
func (cached *IndexOption) CachedSize(alloc bool) int64 {
	...
	// field Name string
	size += hack.RuntimeAllocSize(int64(len(cached.Name)))
	// field Value *github.com/vitess/vitess/go/vt/sqlparser.Literal
...
func (cached *Insert) CachedSize(alloc bool) int64 {
	...
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
	size += cached.Comments.CachedSize(true)
	// field Table *github.com/vitess/vitess/go/vt/sqlparser.AliasedTableExpr
	...
	// field Rows github.com/vitess/vitess/go/vt/sqlparser.InsertRows
	if cc, ok := cached.Rows.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field RowAlias *github.com/vitess/vitess/go/vt/sqlparser.RowAlias
	size += cached.RowAlias.CachedSize(true)
	// field OnDup github.com/vitess/vitess/go/vt/sqlparser.OnDup
	{
...
func (cached *InsertExpr) CachedSize(alloc bool) int64 {
	...
	// field Str github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Str.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Pos github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Pos.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Len github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Len.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field NewStr github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *IntervalDateExpr) CachedSize(alloc bool) int64 {
	...
	// field Date github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Date.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Interval github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONAttributesExpr) CachedSize(alloc bool) int64 {
	...
	// field JSONDoc github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.JSONDoc.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Path github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONContainsExpr) CachedSize(alloc bool) int64 {
	...
	// field Target github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Target.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Candidate github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Candidate.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field PathList []github.com/vitess/vitess/go/vt/sqlparser.Expr
	{
...
func (cached *JSONContainsPathExpr) CachedSize(alloc bool) int64 {
	...
	// field OneOrAll github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONObjectExpr) CachedSize(alloc bool) int64 {
	...
	// field Params []*github.com/vitess/vitess/go/vt/sqlparser.JSONObjectParam
	{
...
func (cached *JSONObjectParam) CachedSize(alloc bool) int64 {
	...
	// field Key github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Key.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Value github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONOverlapsExpr) CachedSize(alloc bool) int64 {
	...
	// field JSONDoc1 github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.JSONDoc1.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field JSONDoc2 github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONPrettyExpr) CachedSize(alloc bool) int64 {
	...
	// field JSONVal github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONQuoteExpr) CachedSize(alloc bool) int64 {
	...
	// field StringArg github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONRemoveExpr) CachedSize(alloc bool) int64 {
	...
	// field PathList github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.PathList)) * int64(16))
		for _, elem := range cached.PathList {
			if cc, ok := elem.(cachedObject); ok {
...
func (cached *JSONSchemaValidFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Schema github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Schema.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Document github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONSearchExpr) CachedSize(alloc bool) int64 {
	...
	// field SearchStr github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.SearchStr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field EscapeChar github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONTableExpr) CachedSize(alloc bool) int64 {
	...
	// field Alias github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.Alias.CachedSize(false)
	// field Filter github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Filter.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Columns []*github.com/vitess/vitess/go/vt/sqlparser.JtColumnDefinition
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Columns)) * int64(8))
		for _, elem := range cached.Columns {
			size += elem.CachedSize(true)
...
func (cached *JSONUnquoteExpr) CachedSize(alloc bool) int64 {
	...
	// field JSONValue github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *JSONValueExpr) CachedSize(alloc bool) int64 {
	...
	// field ReturningType *github.com/vitess/vitess/go/vt/sqlparser.ConvertType
	size += cached.ReturningType.CachedSize(true)
	// field EmptyOnResponse *github.com/vitess/vitess/go/vt/sqlparser.JtOnResponse
	size += cached.EmptyOnResponse.CachedSize(true)
	// field ErrorOnResponse *github.com/vitess/vitess/go/vt/sqlparser.JtOnResponse
...
func (cached *JSONValueMergeExpr) CachedSize(alloc bool) int64 {
	...
	// field JSONDocList github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *JoinCondition) CachedSize(alloc bool) int64 {
	...
	// field On github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.On.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Using github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *JoinTableExpr) CachedSize(alloc bool) int64 {
	...
	// field LeftExpr github.com/vitess/vitess/go/vt/sqlparser.TableExpr
	if cc, ok := cached.LeftExpr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field RightExpr github.com/vitess/vitess/go/vt/sqlparser.TableExpr
	if cc, ok := cached.RightExpr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Condition *github.com/vitess/vitess/go/vt/sqlparser.JoinCondition
...
func (cached *JtColumnDefinition) CachedSize(alloc bool) int64 {
	...
	// field JtOrdinal *github.com/vitess/vitess/go/vt/sqlparser.JtOrdinalColDef
	size += cached.JtOrdinal.CachedSize(true)
	// field JtPath *github.com/vitess/vitess/go/vt/sqlparser.JtPathColDef
	size += cached.JtPath.CachedSize(true)
	// field JtNestedPath *github.com/vitess/vitess/go/vt/sqlparser.JtNestedPathColDef
...
func (cached *LagLeadExpr) CachedSize(alloc bool) int64 {
	...
	// field N github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *Limit) CachedSize(alloc bool) int64 {
	...
	// field Offset github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Offset.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Rowcount github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *LineStringExpr) CachedSize(alloc bool) int64 {
	...
	// field PointParams github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *LinestrPropertyFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Linestring github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *LocateExpr) CachedSize(alloc bool) int64 {
	...
	// field SubStr github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *LockTables) CachedSize(alloc bool) int64 {
	...
	// field Tables github.com/vitess/vitess/go/vt/sqlparser.TableAndLockTypes
	{
...
func (cached *LockingFunc) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *MatchExpr) CachedSize(alloc bool) int64 {
	...
	// field Columns []*github.com/vitess/vitess/go/vt/sqlparser.ColName
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Columns)) * int64(8))
		for _, elem := range cached.Columns {
			size += elem.CachedSize(true)
...
func (cached *MemberOfExpr) CachedSize(alloc bool) int64 {
	...
	// field JSONArr github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *MultiLinestringExpr) CachedSize(alloc bool) int64 {
	...
	// field LinestringParams github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *MultiPolygonExpr) CachedSize(alloc bool) int64 {
	...
	// field PolygonParams github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
...
func (cached *NTHValueExpr) CachedSize(alloc bool) int64 {
	...
	// field OverClause *github.com/vitess/vitess/go/vt/sqlparser.OverClause
	size += cached.OverClause.CachedSize(true)
	// field FromFirstLastClause *github.com/vitess/vitess/go/vt/sqlparser.FromFirstLastClause
...
func (cached *NamedWindow) CachedSize(alloc bool) int64 {
	...
	// field Windows github.com/vitess/vitess/go/vt/sqlparser.WindowDefinitions
	{
...
func (cached *Offset) CachedSize(alloc bool) int64 {
	...
	// field Original github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *OptLike) CachedSize(alloc bool) int64 {
	...
	// field LikeTable github.com/vitess/vitess/go/vt/sqlparser.TableName
...
func (cached *OrderByOption) CachedSize(alloc bool) int64 {
	...
	// field Cols github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *OverClause) CachedSize(alloc bool) int64 {
	...
	// field WindowName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.WindowName.CachedSize(false)
	// field WindowSpec *github.com/vitess/vitess/go/vt/sqlparser.WindowSpecification
...
func (cached *ParenTableExpr) CachedSize(alloc bool) int64 {
	...
	// field Exprs github.com/vitess/vitess/go/vt/sqlparser.TableExprs
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Exprs)) * int64(16))
		for _, elem := range cached.Exprs {
			if cc, ok := elem.(cachedObject); ok {
...
func (cached *ParsedComments) CachedSize(alloc bool) int64 {
	...
	// field comments github.com/vitess/vitess/go/vt/sqlparser.Comments
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.comments)) * int64(16))
		for _, elem := range cached.comments {
			size += hack.RuntimeAllocSize(int64(len(elem)))
	...
	// field _directives *github.com/vitess/vitess/go/vt/sqlparser.CommentDirectives
...
func (cached *ParsedQuery) CachedSize(alloc bool) int64 {
	...
	// field bindLocations []github.com/vitess/vitess/go/vt/sqlparser.BindLocation
	{
...
func (cached *PartitionDefinition) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Options *github.com/vitess/vitess/go/vt/sqlparser.PartitionDefinitionOptions
	size += cached.Options.CachedSize(true)
	return size
}
func (cached *PartitionDefinitionOptions) CachedSize(alloc bool) int64 {
	...
	// field ValueRange *github.com/vitess/vitess/go/vt/sqlparser.PartitionValueRange
	size += cached.ValueRange.CachedSize(true)
	// field Comment *github.com/vitess/vitess/go/vt/sqlparser.Literal
	size += cached.Comment.CachedSize(true)
	// field Engine *github.com/vitess/vitess/go/vt/sqlparser.PartitionEngine
	size += cached.Engine.CachedSize(true)
	// field DataDirectory *github.com/vitess/vitess/go/vt/sqlparser.Literal
	size += cached.DataDirectory.CachedSize(true)
	// field IndexDirectory *github.com/vitess/vitess/go/vt/sqlparser.Literal
	...
	// field SubPartitionDefinitions github.com/vitess/vitess/go/vt/sqlparser.SubPartitionDefinitions
	{
...
func (cached *PartitionOption) CachedSize(alloc bool) int64 {
	...
	// field ColList github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
	...
	// field SubPartition *github.com/vitess/vitess/go/vt/sqlparser.SubPartition
	size += cached.SubPartition.CachedSize(true)
	// field Definitions []*github.com/vitess/vitess/go/vt/sqlparser.PartitionDefinition
	{
...
func (cached *PartitionSpec) CachedSize(alloc bool) int64 {
	...
	// field Names github.com/vitess/vitess/go/vt/sqlparser.Partitions
	{
	...
	// field Number *github.com/vitess/vitess/go/vt/sqlparser.Literal
	size += cached.Number.CachedSize(true)
	// field TableName github.com/vitess/vitess/go/vt/sqlparser.TableName
...
func (cached *PartitionValueRange) CachedSize(alloc bool) int64 {
	...
	// field Range github.com/vitess/vitess/go/vt/sqlparser.ValTuple
	{
...
func (cached *PerformanceSchemaFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Argument github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *PointExpr) CachedSize(alloc bool) int64 {
	...
	// field XCordinate github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.XCordinate.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field YCordinate github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *PointPropertyFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field ValueToSet github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *PolygonPropertyFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Polygon github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *PrepareStmt) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Statement github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Statement.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
...
func (cached *ReferenceDefinition) CachedSize(alloc bool) int64 {
	...
	// field ReferencedTable github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.ReferencedTable.CachedSize(false)
	// field ReferencedColumns github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *RegexpInstrExpr) CachedSize(alloc bool) int64 {
	...
	// field Pattern github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Pattern.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Position github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Position.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Occurrence github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Occurrence.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field ReturnOption github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.ReturnOption.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field MatchType github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *RegexpReplaceExpr) CachedSize(alloc bool) int64 {
	...
	// field Repl github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *RenameColumn) CachedSize(alloc bool) int64 {
	...
	// field OldName *github.com/vitess/vitess/go/vt/sqlparser.ColName
	size += cached.OldName.CachedSize(true)
	// field NewName *github.com/vitess/vitess/go/vt/sqlparser.ColName
...
func (cached *RenameIndex) CachedSize(alloc bool) int64 {
	...
	// field OldName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.OldName.CachedSize(false)
	// field NewName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
...
func (cached *RenameTable) CachedSize(alloc bool) int64 {
	...
	// field TablePairs []*github.com/vitess/vitess/go/vt/sqlparser.RenameTablePair
	{
...
func (cached *RenameTablePair) CachedSize(alloc bool) int64 {
	...
	// field FromTable github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.FromTable.CachedSize(false)
	// field ToTable github.com/vitess/vitess/go/vt/sqlparser.TableName
...
func (cached *RowAlias) CachedSize(alloc bool) int64 {
	...
	// field TableName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.TableName.CachedSize(false)
	// field Columns github.com/vitess/vitess/go/vt/sqlparser.Columns
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Columns)) * int64(32))
...
func (cached *Select) CachedSize(alloc bool) int64 {
	...
	// field With *github.com/vitess/vitess/go/vt/sqlparser.With
	size += cached.With.CachedSize(true)
	// field From []github.com/vitess/vitess/go/vt/sqlparser.TableExpr
	{
	...
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
	size += cached.Comments.CachedSize(true)
	// field SelectExprs github.com/vitess/vitess/go/vt/sqlparser.SelectExprs
	{
	...
	// field Where *github.com/vitess/vitess/go/vt/sqlparser.Where
	size += cached.Where.CachedSize(true)
	// field GroupBy *github.com/vitess/vitess/go/vt/sqlparser.GroupBy
	size += cached.GroupBy.CachedSize(true)
	// field Having *github.com/vitess/vitess/go/vt/sqlparser.Where
	size += cached.Having.CachedSize(true)
	// field Windows github.com/vitess/vitess/go/vt/sqlparser.NamedWindows
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Windows)) * int64(8))
		for _, elem := range cached.Windows {
			size += elem.CachedSize(true)
	...
	// field Limit *github.com/vitess/vitess/go/vt/sqlparser.Limit
	size += cached.Limit.CachedSize(true)
	// field Into *github.com/vitess/vitess/go/vt/sqlparser.SelectInto
...
func (cached *Set) CachedSize(alloc bool) int64 {
	...
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
	size += cached.Comments.CachedSize(true)
	// field Exprs github.com/vitess/vitess/go/vt/sqlparser.SetExprs
	{
...
func (cached *SetExpr) CachedSize(alloc bool) int64 {
	...
	// field Var *github.com/vitess/vitess/go/vt/sqlparser.Variable
...
func (cached *Show) CachedSize(alloc bool) int64 {
	...
	// field Internal github.com/vitess/vitess/go/vt/sqlparser.ShowInternal
...
func (cached *ShowBasic) CachedSize(alloc bool) int64 {
	...
	// field Tbl github.com/vitess/vitess/go/vt/sqlparser.TableName
	size += cached.Tbl.CachedSize(false)
	// field DbName github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.DbName.CachedSize(false)
	// field Filter *github.com/vitess/vitess/go/vt/sqlparser.ShowFilter
...
func (cached *ShowCreate) CachedSize(alloc bool) int64 {
	...
	// field Op github.com/vitess/vitess/go/vt/sqlparser.TableName
...
func (cached *Stream) CachedSize(alloc bool) int64 {
	...
	// field Comments *github.com/vitess/vitess/go/vt/sqlparser.ParsedComments
	size += cached.Comments.CachedSize(true)
	// field SelectExpr github.com/vitess/vitess/go/vt/sqlparser.SelectExpr
...
func (cached *SubPartitionDefinition) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Options *github.com/vitess/vitess/go/vt/sqlparser.SubPartitionDefinitionOptions
	size += cached.Options.CachedSize(true)
	return size
}
...
func (cached *TableAndLockType) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/vitess/vitess/go/vt/sqlparser.TableExpr
...
func (cached *TableName) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.Name.CachedSize(false)
	// field Qualifier github.com/vitess/vitess/go/vt/sqlparser.IdentifierCS
	size += cached.Qualifier.CachedSize(false)
	return size
...
func (cached *TableOption) CachedSize(alloc bool) int64 {
	...
	// field String string
	size += hack.RuntimeAllocSize(int64(len(cached.String)))
	// field Tables github.com/vitess/vitess/go/vt/sqlparser.TableNames
	{
...
func (cached *TableSpec) CachedSize(alloc bool) int64 {
	...
	// field Indexes []*github.com/vitess/vitess/go/vt/sqlparser.IndexDefinition
	{
	...
	// field Constraints []*github.com/vitess/vitess/go/vt/sqlparser.ConstraintDefinition
	{
	...
	// field Options github.com/vitess/vitess/go/vt/sqlparser.TableOptions
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Options)) * int64(8))
		for _, elem := range cached.Options {
			size += elem.CachedSize(true)
...
func (cached *TimestampDiffExpr) CachedSize(alloc bool) int64 {
	...
	// field Expr1 github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Expr1.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Expr2 github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *TrimFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field TrimArg github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *Union) CachedSize(alloc bool) int64 {
	...
	// field With *github.com/vitess/vitess/go/vt/sqlparser.With
	size += cached.With.CachedSize(true)
	// field Left github.com/vitess/vitess/go/vt/sqlparser.SelectStatement
	if cc, ok := cached.Left.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Right github.com/vitess/vitess/go/vt/sqlparser.SelectStatement
	if cc, ok := cached.Right.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field OrderBy github.com/vitess/vitess/go/vt/sqlparser.OrderBy
...
func (cached *Update) CachedSize(alloc bool) int64 {
	...
	// field Exprs github.com/vitess/vitess/go/vt/sqlparser.UpdateExprs
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.Exprs)) * int64(8))
		for _, elem := range cached.Exprs {
			size += elem.CachedSize(true)
...
func (cached *UpdateXMLExpr) CachedSize(alloc bool) int64 {
	...
	// field NewXML github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *VindexParam) CachedSize(alloc bool) int64 {
	...
	// field Key github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
...
func (cached *VindexSpec) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field Type github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Type.CachedSize(false)
	// field Params []github.com/vitess/vitess/go/vt/sqlparser.VindexParam
	{
...
func (cached *WeightStringFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field As *github.com/vitess/vitess/go/vt/sqlparser.ConvertType
...
func (cached *When) CachedSize(alloc bool) int64 {
	...
	// field Cond github.com/vitess/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Cond.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Val github.com/vitess/vitess/go/vt/sqlparser.Expr
...
func (cached *WindowSpecification) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	size += cached.Name.CachedSize(false)
	// field PartitionClause github.com/vitess/vitess/go/vt/sqlparser.Exprs
	{
	...
	// field OrderClause github.com/vitess/vitess/go/vt/sqlparser.OrderBy
	{
	...
	// field FrameClause *github.com/vitess/vitess/go/vt/sqlparser.FrameClause
...
func (cached *With) CachedSize(alloc bool) int64 {
	...
	// field CTEs []*github.com/vitess/vitess/go/vt/sqlparser.CommonTableExpr
	{
