...
func (cached *ArithmeticExpr) CachedSize(alloc bool) int64 {
	...
	// field BinaryExpr mdibaiee/vitess/go/vt/vtgate/evalengine.BinaryExpr
	size += cached.BinaryExpr.CachedSize(false)
	// field Op mdibaiee/vitess/go/vt/vtgate/evalengine.opArith
...
func (cached *BinaryExpr) CachedSize(alloc bool) int64 {
	...
	// field Left mdibaiee/vitess/go/vt/vtgate/evalengine.IR
	if cc, ok := cached.Left.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Right mdibaiee/vitess/go/vt/vtgate/evalengine.IR
...
func (cached *BitwiseExpr) CachedSize(alloc bool) int64 {
	...
	// field BinaryExpr mdibaiee/vitess/go/vt/vtgate/evalengine.BinaryExpr
	size += cached.BinaryExpr.CachedSize(false)
	// field Op mdibaiee/vitess/go/vt/vtgate/evalengine.opBit
	if cc, ok := cached.Op.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	return size
...
func (cached *BitwiseNotExpr) CachedSize(alloc bool) int64 {
	...
	// field UnaryExpr mdibaiee/vitess/go/vt/vtgate/evalengine.UnaryExpr
...
func (cached *CallExpr) CachedSize(alloc bool) int64 {
	...
	// field Arguments mdibaiee/vitess/go/vt/vtgate/evalengine.TupleExpr
	{
...
func (cached *CaseExpr) CachedSize(alloc bool) int64 {
	...
	// field cases []mdibaiee/vitess/go/vt/vtgate/evalengine.WhenThen
	{
	...
	// field Else mdibaiee/vitess/go/vt/vtgate/evalengine.IR
...
func (cached *ComparisonExpr) CachedSize(alloc bool) int64 {
	...
	// field BinaryExpr mdibaiee/vitess/go/vt/vtgate/evalengine.BinaryExpr
	size += cached.BinaryExpr.CachedSize(false)
	// field Op mdibaiee/vitess/go/vt/vtgate/evalengine.ComparisonOp
	if cc, ok := cached.Op.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	return size
...
func (cached *CompiledExpr) CachedSize(alloc bool) int64 {
	...
	// field code []mdibaiee/vitess/go/vt/vtgate/evalengine.frame
	{
		size += hack.RuntimeAllocSize(int64(cap(cached.code)) * int64(8))
	}
	// field typed mdibaiee/vitess/go/vt/vtgate/evalengine.ctype
	size += cached.typed.CachedSize(false)
	// field ir mdibaiee/vitess/go/vt/vtgate/evalengine.IR
...
func (cached *IntervalExpr) CachedSize(alloc bool) int64 {
	...
	// field CallExpr mdibaiee/vitess/go/vt/vtgate/evalengine.CallExpr
...
func (cached *LikeExpr) CachedSize(alloc bool) int64 {
	...
	// field BinaryExpr mdibaiee/vitess/go/vt/vtgate/evalengine.BinaryExpr
	size += cached.BinaryExpr.CachedSize(false)
	// field Match mdibaiee/vitess/go/mysql/collations/colldata.WildcardPattern
...
func (cached *Literal) CachedSize(alloc bool) int64 {
	...
	// field inner mdibaiee/vitess/go/vt/vtgate/evalengine.eval
...
func (cached *LogicalExpr) CachedSize(alloc bool) int64 {
	...
	// field BinaryExpr mdibaiee/vitess/go/vt/vtgate/evalengine.BinaryExpr
	size += cached.BinaryExpr.CachedSize(false)
	// field op mdibaiee/vitess/go/vt/vtgate/evalengine.opLogical
	if cc, ok := cached.op.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	return size
...
func (cached *UnaryExpr) CachedSize(alloc bool) int64 {
	...
	// field Inner mdibaiee/vitess/go/vt/vtgate/evalengine.IR
	if cc, ok := cached.Inner.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	return size
...
func (cached *UntypedExpr) CachedSize(alloc bool) int64 {
	...
	// field env *mdibaiee/vitess/go/vt/vtenv.Environment
	size += cached.env.CachedSize(true)
	// field ir mdibaiee/vitess/go/vt/vtgate/evalengine.IR
	if cc, ok := cached.ir.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field needTypes []mdibaiee/vitess/go/vt/vtgate/evalengine.typedIR
	{
	...
	// field typed []*mdibaiee/vitess/go/vt/vtgate/evalengine.typedExpr
	{
...
func (cached *WhenThen) CachedSize(alloc bool) int64 {
	...
	// field when mdibaiee/vitess/go/vt/vtgate/evalengine.IR
	if cc, ok := cached.when.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field then mdibaiee/vitess/go/vt/vtgate/evalengine.IR
...
func (cached *evalDecimal) CachedSize(alloc bool) int64 {
	...
	// field dec mdibaiee/vitess/go/mysql/decimal.Decimal
...
func (cached *evalTuple) CachedSize(alloc bool) int64 {
	...
	// field t []mdibaiee/vitess/go/vt/vtgate/evalengine.eval
	{
...
func (cached *typedExpr) CachedSize(alloc bool) int64 {
	...
	// field types []mdibaiee/vitess/go/vt/vtgate/evalengine.ctype
	{
	...
	// field compiled *mdibaiee/vitess/go/vt/vtgate/evalengine.CompiledExpr
