...
func (cached *CFC) CachedSize(alloc bool) int64 {
	...
	// field cfcCommon *mdibaiee/vitess/go/vt/vtgate/vindexes.cfcCommon
	size += cached.cfcCommon.CachedSize(true)
	// field prefixCFC *mdibaiee/vitess/go/vt/vtgate/vindexes.prefixCFC
...
func (cached *ColumnVindex) CachedSize(alloc bool) int64 {
	...
	// field Columns []mdibaiee/vitess/go/vt/sqlparser.IdentifierCI
	{
...
func (cached *ConsistentLookup) CachedSize(alloc bool) int64 {
	...
	// field clCommon *mdibaiee/vitess/go/vt/vtgate/vindexes.clCommon
...
func (cached *LookupHash) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field lkp mdibaiee/vitess/go/vt/vtgate/vindexes.lookupInternal
...
func (cached *MultiCol) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field columnVdx map[int]mdibaiee/vitess/go/vt/vtgate/vindexes.Hashing
...
func (cached *NumericStaticMap) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field hashVdx mdibaiee/vitess/go/vt/vtgate/vindexes.Hashing
	if cc, ok := cached.hashVdx.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field lookup mdibaiee/vitess/go/vt/vtgate/vindexes.NumericLookupTable
...
func (cached *RegionJSON) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field regionMap mdibaiee/vitess/go/vt/vtgate/vindexes.RegionMap
