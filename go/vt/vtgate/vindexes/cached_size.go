...
func (cached *CFC) CachedSize(alloc bool) int64 {
	...
	// field cfcCommon *github.com/vitess/vitess/go/vt/vtgate/vindexes.cfcCommon
	size += cached.cfcCommon.CachedSize(true)
	// field prefixCFC *github.com/vitess/vitess/go/vt/vtgate/vindexes.prefixCFC
...
func (cached *ColumnVindex) CachedSize(alloc bool) int64 {
	...
	// field Columns []github.com/vitess/vitess/go/vt/sqlparser.IdentifierCI
	{
...
func (cached *ConsistentLookup) CachedSize(alloc bool) int64 {
	...
	// field clCommon *github.com/vitess/vitess/go/vt/vtgate/vindexes.clCommon
...
func (cached *LookupHash) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field lkp github.com/vitess/vitess/go/vt/vtgate/vindexes.lookupInternal
...
func (cached *MultiCol) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field columnVdx map[int]github.com/vitess/vitess/go/vt/vtgate/vindexes.Hashing
...
func (cached *NumericStaticMap) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field hashVdx github.com/vitess/vitess/go/vt/vtgate/vindexes.Hashing
	if cc, ok := cached.hashVdx.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field lookup github.com/vitess/vitess/go/vt/vtgate/vindexes.NumericLookupTable
...
func (cached *RegionJSON) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += hack.RuntimeAllocSize(int64(len(cached.name)))
	// field regionMap github.com/vitess/vitess/go/vt/vtgate/vindexes.RegionMap
