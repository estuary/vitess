...
func (cached *TabletPlan) CachedSize(alloc bool) int64 {
	...
	// field Plan *mdibaiee/vitess/go/vt/vttablet/tabletserver/planbuilder.Plan
	size += cached.Plan.CachedSize(true)
	// field Original string
	size += hack.RuntimeAllocSize(int64(len(cached.Original)))
	// field Rules *mdibaiee/vitess/go/vt/vttablet/tabletserver/rules.Rules
	size += cached.Rules.CachedSize(true)
	// field Authorized []*mdibaiee/vitess/go/vt/tableacl.ACLResult
	{
