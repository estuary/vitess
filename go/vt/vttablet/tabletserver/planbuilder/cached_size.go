...
func (cached *Plan) CachedSize(alloc bool) int64 {
	...
	// field Table *mdibaiee/vitess/go/vt/vttablet/tabletserver/schema.Table
	size += cached.Table.CachedSize(true)
	// field AllTables []*mdibaiee/vitess/go/vt/vttablet/tabletserver/schema.Table
	{
	...
	// field Permissions []mdibaiee/vitess/go/vt/vttablet/tabletserver/planbuilder.Permission
	{
	...
	// field FullQuery *mdibaiee/vitess/go/vt/sqlparser.ParsedQuery
	size += cached.FullQuery.CachedSize(true)
	// field NextCount mdibaiee/vitess/go/vt/vtgate/evalengine.Expr
	if cc, ok := cached.NextCount.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field WhereClause *mdibaiee/vitess/go/vt/sqlparser.ParsedQuery
	size += cached.WhereClause.CachedSize(true)
	// field FullStmt mdibaiee/vitess/go/vt/sqlparser.Statement
