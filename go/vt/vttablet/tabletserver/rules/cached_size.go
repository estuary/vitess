...
func (cached *BindVarCond) CachedSize(alloc bool) int64 {
	...
	// field value github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.bvcValue
...
func (cached *Rule) CachedSize(alloc bool) int64 {
	...
	// field Name string
	size += hack.RuntimeAllocSize(int64(len(cached.Name)))
	// field requestIP github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.namedRegexp
	size += cached.requestIP.CachedSize(false)
	// field user github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.namedRegexp
	size += cached.user.CachedSize(false)
	// field query github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.namedRegexp
	size += cached.query.CachedSize(false)
	// field leadingComment github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.namedRegexp
	size += cached.leadingComment.CachedSize(false)
	// field trailingComment github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.namedRegexp
	size += cached.trailingComment.CachedSize(false)
	// field plans []github.com/estuary/vitess/go/vt/vttablet/tabletserver/planbuilder.PlanType
	{
	...
	// field bindVarConds []github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.BindVarCond
	{
...
func (cached *Rules) CachedSize(alloc bool) int64 {
	...
	// field rules []*github.com/estuary/vitess/go/vt/vttablet/tabletserver/rules.Rule
	{
