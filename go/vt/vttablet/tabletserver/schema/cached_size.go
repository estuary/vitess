...
func (cached *Table) CachedSize(alloc bool) int64 {
	...
	// field SequenceInfo *github.com/vitess/vitess/go/vt/vttablet/tabletserver/schema.SequenceInfo
	if cached.SequenceInfo != nil {
		size += hack.RuntimeAllocSize(int64(24))
	}
	// field MessageInfo *github.com/vitess/vitess/go/vt/vttablet/tabletserver/schema.MessageInfo
