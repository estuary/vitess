...
// Source: mdibaiee/vitess/oracle/go/vt/discovery (interfaces: HealthCheck)
...
import (
	...
	discovery "mdibaiee/vitess/oracle/go/vt/discovery"
	query "mdibaiee/vitess/oracle/go/vt/proto/query"
	topodata "mdibaiee/vitess/oracle/go/vt/proto/topodata"
	queryservice "mdibaiee/vitess/oracle/go/vt/vttablet/queryservice"
)
