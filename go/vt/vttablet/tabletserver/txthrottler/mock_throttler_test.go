...
// Source: mdibaiee/vitess/go/vt/vttablet/tabletserver/txthrottler (interfaces: ThrottlerInterface)
...
import (
	...
	discovery "mdibaiee/vitess/go/vt/discovery"
	throttlerdata "mdibaiee/vitess/go/vt/proto/throttlerdata"
