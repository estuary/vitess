...
import (
	...
	workflow2 "mdibaiee/vitess/oracle/go/vt/vtctl/workflow"
	vtctldvexec "mdibaiee/vitess/oracle/go/vt/vtctl/workflow/vexec" // renamed to avoid a collision with the vexec struct in this package
)
