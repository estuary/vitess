...
RUN rm -rf /vt/src/mdibaiee/vitess/oracle/*
COPY . /vt/src/mdibaiee/vitess/oracle
...
WORKDIR /vt/src/mdibaiee/vitess/oracle
...
ENV VTROOT /vt/src/mdibaiee/vitess/oracle
