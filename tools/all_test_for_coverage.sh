...
do
   go test -coverpkg=mdibaiee/vitess/oracle/go/... -coverprofile "/tmp/unit_$counter.out" -json > "/tmp/unit_$counter.json" $pkg -v -p=1 || :
   counter=$((counter+1))
done
...
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vtctl -o ./bin/vtctl
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vtctld -o ./bin/vtctld
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/mysqlctl -o ./bin/mysqlctl
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vtctlclient -o ./bin/vtctlclient
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vttablet -o ./bin/vttablet
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vtgate -o ./bin/vtgate
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vtworker -o ./bin/vtworker
go test -coverpkg=mdibaiee/vitess/oracle/go/...  -c mdibaiee/vitess/oracle/go/cmd/vtworkerclient -o ./bin/vtworkerclient
