...
do
   go test -coverpkg=github.com/vitess/vitess/go/... -coverprofile "/tmp/unit_$counter.out" -json > "/tmp/unit_$counter.json" $pkg -v -p=1 || :
   counter=$((counter+1))
done
...
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vtctl -o ./bin/vtctl
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vtctld -o ./bin/vtctld
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/mysqlctl -o ./bin/mysqlctl
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vtctlclient -o ./bin/vtctlclient
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vttablet -o ./bin/vttablet
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vtgate -o ./bin/vtgate
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vtworker -o ./bin/vtworker
go test -coverpkg=github.com/vitess/vitess/go/...  -c github.com/vitess/vitess/go/cmd/vtworkerclient -o ./bin/vtworkerclient
